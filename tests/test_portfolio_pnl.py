...
def test_realized_pnl_on_futures_reversal():
    """
    ...
    portfolio.update_futures_position(10000.0, entry_price)
    ...
    portfolio.update_futures_position(-4000.0, close_price)
    ...
    flip_price = 52000.0
    portfolio.update_futures_position(-13000.0, flip_price)
    ...
    portfolio.update_futures_position(2000.0, reduce_price)
